...
public class LoadExtraBuilder {
    ...
    private TypeMirror iProviderType;
    ...
    public void setElementUtils(Elements elementUtils) {
        ...
        iProviderType = elementUtils.getTypeElement(Constants.IPROVIDER).asType();
    }
    ...
    public void buildStatement(Element element) {
        ...
        //获得注解 name值
        String extraName = element.getAnnotation(SolarexExtra.class).name();
    ...
    private void addObjectStatement(String statement, String fieldName, String extraName,
        ...
        } else if (typeUtils.isSubtype(typeMirror, iProviderType)) {
